...
#image_filename = "./split-cc-graphs-processes/" + file_name + ".png"   #edx running machine: split version cc
#image_filename = "./split-cc-graphs-free-ram/" + file_name + ".png"   #edx running machine: split version cc
#image_filename = "./split-cc-graphs-cs/" + file_name + ".png"   #edx running machine: split version cc
image_filename = "./split-cc-graphs-idle-cpu/" + file_name + ".png"   #edx running machine: split version cc
...
#os.system("awk '{print $2}' " + file_name + "| tail -n +3" +  ">"  + file_name + ".updated")  # this line is for printing RAM utilization
