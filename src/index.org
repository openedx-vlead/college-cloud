...
** Portable Edition Requirement
   ...
   - Analytics to be fetched from portble hardriver version.  [[https://github.com/openedx-vlead/portable-media/issues/2][Read link]]
...
* Design Plan on 2016-09-26
  ...
  - Portable edition of Virtual Labs :: 
    ...
    + Cluster :: 
	 ...
	 Static IP(192.168.2.5) is to be assigned to Config-server container.
