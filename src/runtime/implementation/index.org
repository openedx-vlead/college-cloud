...
def post_data_to_elastic_db(record, record_type, mac_id):
	...
	ELASTIC_DB_URL = "http://feedback.vlabs.ac.in/dump_feedback_to_elk"
	...
	ELASTIC_DB_URL = "http://feedback.vlabs.ac.in/dump_usages_to_elk"
    else:
	data_dict = {
	    "college_details" : record,
	    "key" : "defaultkey"
	}
	ELASTIC_DB_URL = "http://feedback.vlabs.ac.in/dump_cc_details_to_elk"

    try:
	resp = requests.post(ELASTIC_DB_URL, data=json.dumps(data_dict))
