...
datewise_dump()
{
     ...
     echo "`mv feedback-dump-$DATE.json  $LOCAL_WORKSHOP_DIR/`" 
     echo "`date`: End Mysql dump for feedback " >> $LOCAL_WORKSHOP_DIR/exec-status-$DATE.txt
...
<<setup_file>>
#+END_SRC   
#+BEGIN_SRC shell :tangle script/conf.sh :eval no :noweb yes
<<config_file>>
#+END_SRC  
#+BEGIN_SRC shell :tangle script/fetch_analytics.sh :eval no :noweb yes
<<fetch_analytics>>  
#+END_SRC
#+BEGIN_SRC python :tangle script/feedback-dump.py :eval no :noweb yes
<<fetch_feedbacks>>  
#+END_SRC
