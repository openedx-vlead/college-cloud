...
* Implementation of College Cloud 
  ...
  :END: 
  - Implementation is done based on the [[../requirements/index.org::#cc_design][design diagram]]
...
* Collecting logs from College Cloud   
  - [[../requirements/index.org::#logg_collection][Requirement]] satisfied in this implementation
   :PROPERTIES:
