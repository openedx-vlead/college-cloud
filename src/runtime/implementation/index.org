...
* College Cloud registration
  [[../../requirements/index.org::#req4][Requirement satisfied]] 
...
* Post Process script
  ...
  [[../../requirements/index.org::#req5][Requirement satisfied]]
  :PROPERTIES:
  :CUSTOM_ID: post_workshop
  :END: 
** configuration
...
if __name__ == "__main__":
    ...
    try:
        ...
        #print "**** analytics data before adding config data begin****"
        #print analytics_dump
        #print "**** analytics data before adding config data end****"
