...
*** No internet in Collge Cloud Edition
   ...
   3. Visit the URL - =http://<college-cloud-server-ip>/get_cc_mac_id=
      to know the =mac address= of the college cloud and also please save this
      for the future reference.
      - Note :: Obtained =Mac address= is useful for [[http://community.vlabs.ac.in/docs/user-manuals/outreach-portal/#sec-3-3-1][obtaining usage]] for offline workshops from outreach portal.
