...
* Requirements
  ...
  1. College Cloud System Configuration (recommended) 
     ...
     #+END_EXAMPLE
  2. WiFi Router
  3. Computer Lab with at least 30-50 Systems/Desktops.
  4. Network Switch Input, from where all the labs would obtain DHCP
  ...
  5. System Administrator with basic knowledge of CentOS operating systems and
     networking.
...
**** Syncthing
    ...
    6. Then follow the below steps
       - [[./syncthing/index.org::#webgui][Access the webGUI]]
       - [[./syncthing/index.org::#share_files][Share Logs/analytics to VLEAD team]]
**** Manual Sharing
    :PROPERTIES:
...
** Analytics and Feedback : Workshop Coordinator
   ...
   3. OR Collect and share logs automatically using [[./installation-manual.org::#syncthing][Syncthing]] if internet connection is available in the college.
