...
* Configuring College Cloud Server
  ...
  5. Please use [[./user-manual.org::#passwords][default linux user credentials]] to login.
     + NOTE :: It is advised that the password is changed after the
               first login . To change the password, follow the
...
** Open edX platform admin user password
   ...
   To change the Open edX platform  admin( default) user password
    ...
    - Login using default [[Passwords][admin user and password]].
...
** Selecting labs
   ...
   - This would prompt for the user name and password. Please provide
     [[./user-manual.org::#passwords][default user credentials]]. 
    + NOTE :: It is advised that the password is changed after the
              first login . For the steps for changing the password,
              follow the [[./user-manual.org::#OpenVZ][link]]
...
** Starting Lab containers
    ...
    4. Sign into =OpenVZ web panel=. For credentials, please follow
       the [[./user-manual.org::#passwords][passwords]]
...
** Monitoring system resources
   ...
   - Use the Nagios [[./user-manual.org::#passwords][default user credentials]]

    + NOTE :: It is advised that the password is changed after the
              first login . For the steps for changing the password,
              follow the [[./user-manual.org::#nagios_password][link]]
...
**** System Administrator/Workshop coordinator 
     ...
     - Log in using admin user credentials. Admin user credentials are
       at [[./user-manual.org::#passwords][passwords]]
      + NOTE :: It is advised that the password is changed after the
                first login . For the steps for changing the password,
                follow the [[./user-manual.org::#platform_password][link]].
...
** Workshop conducted by Workshop Coordinator
   ...
   + Make sure the [[./user-manual.org::#requirements][requirements]] are met by the college.
   + [[./user-manual.org::#cc-server][Configure College Cloud Server]]
   + [[./user-manual.org::#using-cc-server][Using College Cloud]]
   + [[./user-manual.org::#analytics-feedbacks][Collecting Analytics and Feedback]]
...
*** On existing College Cloud Server
  - Log in to the existing *College Cloud Server (old)* as a super user
    using [[./user-manual.org::#passwords][default user credentials]]
    #+BEGIN_EXAMPLE
    su -
...
*** Setup new machine as College Cloud Server
    ...
    + Make sure that the machine meets the [[./user-manual.org::#requirements][requirements]]
    + [[./user-manual.org::#cc-server][Configure College Cloud Server]]
    + [[./user-manual.org::#using-cc-server][Using College Cloud]]
    + [[./user-manual.org::#analytics-feedbacks][Collecting Analytics and Feedback]]
** Instructions for the  existing lab users 
   ...
   - Follow the link  [[./user-manual.org::#dns-settings][Changing DNS settings]]
